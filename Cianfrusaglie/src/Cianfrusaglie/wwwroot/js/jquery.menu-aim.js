...
( function($) {
    $.fn.menuAim = function(opts) {
        ...
        this.each(function() { init.call(this, opts); });
    ...
    function init(opts) {
        ...
        var activationDelay = function() {
            ...
            if( prevLoc.x < offset.left ||
                prevLoc.x > lowerRight.x ||
                prevLoc.y < offset.top ||
                prevLoc.y > lowerRight.y ) // If the previous mouse location was outside of the entire
            // menu's bounds, immediately activate.
                return 0;

            if( lastDelayLoc &&
                loc.x == lastDelayLoc.x &&
                loc.y == lastDelayLoc.y ) // If the mouse hasn't moved since the last time we checked
